<template>
    <div class="relative">
      ...
      <input
        :class="error ? 'border-[#DA5252]' : ' border-neutral-900/[40%]'"
        class="w-full bg-gray-200 cursor-not-allowed font-light font-Satoshi400 text-[14px] outline-none !p-[14px] border-[1px] opacity-[0.8029] rounded-[4px] text-sm"
