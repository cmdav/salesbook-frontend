...
export function usePostComposable(url, formFields, postUrl = null,  fieldsOverride = {}, emit) {
    ...
    const submitForm = async () => {
      try {
        ...
        const modifiedFields =formFields.map(field => {
          if (fieldsOverride && Object.prototype.hasOwnProperty.call(fieldsOverride, field.databaseField)) {
