<template>
      ...
      <div class="container p-0 lg:p-6 lg:py-3 py-4 mb-5">
        ...
        <form @submit.prevent="handleAddSales">
          ...
          <div class="my-8">
            ...
            <div v-for="(product, index) in formState.products" :key="index" class="product-group flex justify-between items-end mt-4">
              ...
              <div class="input-group w-20">
                ...
                <input type="number" :value="formState.products[index].available_qty" class="input" readonly />
              </div>
  
              <div class="input-group w-20">
                <label class="block text-sm font-medium text-gray-700">Price</label>
                <input required v-model="formState.products[index].price_sold_at" type="number" class="input" readonly />
              </div>
  
              <div class="input-group w-20">
                <label class="block text-sm font-medium text-gray-700">Qty Sold</label>
                <input required v-model="formState.products[index].quantity" type="number" class="input" />
              </div>
  ...
  import { getDb, getAllDb, setDb } from '@/utils/indexedDB';
