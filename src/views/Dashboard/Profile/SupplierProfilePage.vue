<template>
  <SupplierLayout pageTitle="Supplier Profile">
    <div class="container p-0 lg:p-6 lg:py-3 py-4 mb-5">
      ...
      >
        ...
        <div class="text-center">
          <p 
            class="text-[#000000] text-[24.518px] capitalize items-center font-bold leading-[31.739px]"
          >
            {{
          ...
          >
          <p
            class="text-[#000000] !my-1.5 text-[18px] gap-[8px] items-center leading-[31.739px] font-bold"
          >
            {{ userProfileDetails?.company_name }}
          </p>
          <!-- <p
...
import SupplierLayout from "@/components/Layouts/supplierDashboardLayout.vue"
